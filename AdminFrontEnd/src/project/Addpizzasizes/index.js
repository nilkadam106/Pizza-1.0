        ...
        {products.map((product, i) => {
            return (
              <div key={i}>
                ...
                <div className="mb-3">
                    <label htmlFor="exampleFormControlInput1" className="form-label">Enter pizza size</label>
                    <br />
                ...
                <div className="mb-3">
                    <label htmlFor="exampleFormControlInput1" className="form-label">Enter pizza price</label>
                    <br />

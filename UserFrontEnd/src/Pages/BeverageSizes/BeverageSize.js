...
export default function BeverageSize() {
    ...
    const getItemSize = () => {
        const url = `${URL}itemSize/${itemid}/200ml`
                            ...
                            <div>
                                ...
                                <div>
                                    <div className="row">
                                        <div className="col">
                                            <center>
                                                <motion.img src={URL + 'itemImage/item/' + varioussize.item.itemid} alt="itemImage" className='shadow img-thumbnail' style={{ height: "380px", width: "480px", borderRadius: "10px", minWidth: "350px" }}

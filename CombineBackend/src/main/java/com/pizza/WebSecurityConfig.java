...
//    }
	...
	public SecurityFilterChain configureAuthorization(HttpSecurity http) throws Exception{
    	...
    	.and()
    	.authorizeRequests().antMatchers("/user/signup/**","/v3/**","/swagger-ui/**","/user/signin/**","/item/**","/itemImage/**","/cart/updateCartStatus/**","/feedback/addFeedback","/user/resetPassword","/user/newPassword").permitAll()
